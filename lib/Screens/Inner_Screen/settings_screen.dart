          ...
          warningDialog(
              ...
              onPressed: () async{
                  try {
                    ...
                    await AuthApiController().deleteAccount(auth.userModel?.id.toString() ?? '');
                  } catch (e) {
                    ///
                  }
                  ...
                  child: Row(
                      ...
                      children: [
                        ...
                        Switch(
                          ...
                          inactiveTrackColor: AppColor.secondaryColor.withOpacity(0.5),
                          activeTrackColor: AppColor.endColor,
                          onChanged: (value) => langProvider.changeLanguage(),
                        ),
                      ],
                      ),
                  ),
